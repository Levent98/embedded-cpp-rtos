...
/* clang-tidy: these legacy protocol/config constants intentionally remain macros for C compatibility. */
...
enum
{
    CONFIG_FLASH_ADDR = 0x08004000U,
    CONFIG_MAGIC_NUM  = 0xABCD1234U
};
