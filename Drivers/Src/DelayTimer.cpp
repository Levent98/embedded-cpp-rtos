...
{
    DelayTimer::delayUs(us);
}

extern "C" void Delay_ms(uint16_t ms)
{
    DelayTimer::delayMs(ms);
}

extern "C" uint32_t GetTick(void)
{
    return DelayTimer::tickMs();
}
...
void DelayTimer::delayUs(uint16_t us)
{
...
void DelayTimer::delayMs(uint16_t ms)
{
